...
Photos
Tap the Photos icon on the Home screen to see your pictures. Flick right or left to move between images. Double-tap or pinch to zoom. Tap once to bring up the onscreen controls. You can edit or enhance a photo, share it via Mail, iMessage, Facebook, or Twitter, print it, and more. If you have Photo Stream enabled in iCloud, new pictures you take are automatically pushed to all your other devices.

Safari
In Safari, double-tap any element on a web page-picture or text-to zoom in. Double-tap again to zoom back out. Rotate iPhone to see the web in widescreen. Tap the Reader button at the top of the screen to view an article without clutter. Tap the Multi-page button to flick between web pages or open a new one. Tap the Share button to share a web page via Mail, iMessage, Facebook, or Twitter or save it to your Reading List.

Maps
To see where you are on a map, tap the Location button. A blue dot appears at your current position. Use two fingers to rotate the map, or pinch to zoom. To title the map, drag two fingers up or down. Find places around you by typing words like "Starbucks" or "pizza" in the search field. Tap the Quick Route button to start turn-by-turn navigation. Curl up the map page to display traffic conditions and change the map view.

App Store and iTunes Store
Tap teh App Store icon to browse apps in categories like games, travel, social networking, and more. To purchase and download an app directly to your iphone, tap Buy Now. Many apps are even free. Tap the iTunes icon to search for music, movies, TV shows, and more. Then tap to purchase and download wirelessly.

iCloud
iCloud stores your music, photos, apps, calendars, documents, and more.It's seamlessly integrated into your apps and wirelessly pushes your content to all your devices. You can also download music and apps you've previously purchases from the iTunes Store and the App Store.

Learn more
Learn more about iPhone features at www.apple.com/iphone.

For instructions and safety and handling information, see the iPhone User Guide at www.apple.com/support/manuals/iphone. To view the user guide on iPhone, download it from the iBookstore or use the Safari bookmark.

Get support
Contact your wireless service provider for support on network service, voicemail, and billing. Visit www.apple.com/support/iphone for support on iPhone and iTunes.
